...
<div class="container">
  <h2></h2>
  <p></p>
  <form action="insert.trbo" method="post"  enctype="multipart/form-data" >
    <div class="form-group">
      <label for="usr">제목 </label>
      <input type="text" class="form-control" id="tptitle" name="tpTitle">
    </div>
    <div class="form-group">
      <label for="content">내용</label>
      <input type="text" class="form-control" id="tpcontent" name="tpContent">
    </div>
   	<!--  아래는 드래그  --> 
