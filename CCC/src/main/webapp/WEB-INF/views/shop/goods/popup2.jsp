...
<style>
	...
	position:fixed; left:35%; top:38%; transform:translate(-50%, -50%); padding:30px; background:#fff; border-radius:6px; }
	...
	float: left;text-decoration:none;width: 200px; 
...
<!-- 	        <h4 class="title">GOODS 공지사항</h4> -->
	        <div class="cont">
	            <p>
					...
					<img src="resources/goodsImg/popup/img02.gif" width=450px height=300px usemap="#popup" alt="event page">
	            </p>
	        </div>
				<form name="pop_form">
